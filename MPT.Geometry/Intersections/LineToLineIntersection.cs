...
namespace MPT.Geometry.Intersections
{
    ...
    /// </summary>
    public class LineToLineIntersection
    {
        ...
        private static bool slopeIsDownwardBetweenCoordinates(
            CartesianCoordinate coordinateI, 
            CartesianCoordinate coordinateJ,
            double tolerance = GeometryLibrary.ZeroTolerance)
        {
            return coordinateJ.Y.IsLessThan(coordinateI.Y, tolerance);
        }

        private static int numberOfIntersectionsHorizontal(CartesianCoordinate coordinate, CartesianCoordinate vertexI, CartesianCoordinate vertexJ)
        {
            double xIntersection = IntersectionPointX(coordinate.Y, vertexI, vertexJ);
            return PointIsLeftOfSegmentIntersection(coordinate.X, xIntersection, vertexI, vertexJ) ? 1 : 0;
        }

        private static bool pointHorizontalProjectionIntersectsVertex(
            CartesianCoordinate coordinate,
            CartesianCoordinate vertex, 
            double tolerance = GeometryLibrary.ZeroTolerance)
        {
            return (coordinate.Y.IsEqualTo(vertex.Y, tolerance) &&
                    coordinate.X.IsLessThan(vertex.X, tolerance));
        }
        ...
        public static bool PointIsWithinLineHeightInclusive(
            double yPtN,
        ...
        /// <param name="ptJ">The vertex j.</param>
        /// <returns><c>true</c> if the point lies within the segment extents height, <c>false</c> otherwise.</returns>
        public static bool PointIsWithinLineHeightExclusive(
            double yPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        public static bool PointIsWithinLineWidthInclusive(
            double xPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        /// <param name="ptJ">The vertex j.</param>
        /// <returns><c>true</c> if the point lies within the segment width, <c>false</c> otherwise.</returns>
        public static bool PointIsWithinLineWidthExclusive(
            double xPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        public static bool PointIsLeftOfLineEndInclusive(
            double xPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        /// <param name="ptJ">Vertex j.</param>
        /// <returns><c>true</c> if the point lies to the left of the straight line end, <c>false</c> otherwise.</returns>
        public static bool PointIsLeftOfLineEndExclusive(
            double xPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        public static bool PointIsBelowLineBottomInclusive(
            double yPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        /// <param name="ptJ">Vertex j.</param>
        /// <returns><c>true</c> if the point lies to below the segment bottom, <c>false</c> otherwise.</returns>
        public static bool PointIsBelowLineBottomExclusive(
            double yPtN,
            CartesianCoordinate ptI,
            CartesianCoordinate ptJ)
        {
        ...
        public static bool PointIsLeftOfSegmentIntersection(
            ...
            CartesianCoordinate vertexI,
            CartesianCoordinate vertexJ)
        {
            return (xPtN < xIntersection &&
                    PointIsWithinLineWidthInclusive(xIntersection, vertexI, vertexJ));
        }
            ...
            CartesianCoordinate vertexJ)
        {
            return (yPtN < yIntersection &&
                    PointIsWithinLineHeightInclusive(yIntersection, vertexI, vertexJ));
        }
